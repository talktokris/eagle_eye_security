                            ...
                            <div class="media-body content align-self-center">
                                <a class="icon-box-anchor">
                                    <button class="btn-panthar btn-border-base footer-subscribe-btn">
                                        ...
                                        Apply For Job <i class="far fa-paper-plane"></i>
                    ...
                    <div class="footer-widget widget">
                        ...
                        <ul class="theme-recent-post-wrap news-footer">
                            <li class="theme-recent-post-item" style="border-bottom: 1px dashed red !important;">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="./assets/img/section-img/blog/blogcat-01.png"
                                            alt="How much does it cost to rent a private jet?">
                                    </a>
                                </div>
                                <div class="content">
                                    <span class="time news-footer-date">Jan 20, 2022</span>
                                    <h4 class="title"><a href="blog-single.html" class="news-footer-link">How
                                            much does it cost to rent a private jet?</a></h4>
                                </div>
                            </li>
                            ...
                            <li class="theme-recent-post-item">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="./assets/img/section-img/blog/cat-01.png"
                                            alt="A complete guide to flying with your pets">
                                    </a>
                                </div>
                                <div class="content">
                                    <span class="time news-footer-date">Dec 6, 2021</span>
                                    <h4 class="title"><a href="blog-single.html" class="news-footer-link">A
                                            complete guide to flying with your pets</a></h4>
                                </div>
                            </li>
                            ...
                            <li class="theme-recent-post-item">
                                <div class="thumb">
                                    <a href="#">
                                        <img src="./assets/img/section-img/blog/cat-02.png"
                                            alt="How Much Luggage Can I Take on a Private Jet?">
                                    </a>
                                </div>
                                <div class="content">
                                    <span class="time news-footer-date">Dec 6, 2021</span>
                                    <h4 class="title"><a href="blog-single.html" class="news-footer-link">How
                                            Much Luggage Can I Take on a Private Jet?</a></h4>
                                </div>
                            </li>
