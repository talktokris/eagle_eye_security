						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									...
									<form class="row needs-validation" method="post" action="{{ url('/admin/news/create-news') }}" >
                                    @csrf
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea id="text" name="text"  class="form-control @error('text') is-invalid @enderror"  rows="8" cols="50"  required="">{{ old('text') }}</textarea>
