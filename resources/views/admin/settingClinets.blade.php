...
<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Client Category</li>
							</ol>
						</nav>
					</div>
				...
				<!--end breadcrumb-->
				<h6 class="mb-0 text-uppercase">Client Category List</h6>
				<hr/>
                <div class="row col-md-9">
                    <a href="{{ url('admin/client/category/create') }}" class="btn btn-primary btn-create-top">Create Client Category</a>
						...
						<div class="table-responsive">
							<table id="example" class="table table-striped table-bordered dataTable" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td style="">{{ $item->name_short}}</td>
                                    <td style="">{{ $item->full_name}}</td>
                                    <td><?php echo $statusSting;?></td>
                                    <td><a href="<?php echo url('/admin/setting/client/delete').'/'. base64_encode($item->id) ;?>" class="btn btn-danger"><i class="bx bx-trash"></i></a></td>
