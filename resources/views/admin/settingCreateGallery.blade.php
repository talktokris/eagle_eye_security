...
<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Gallery Category</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-news"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">New Gallery Category</li>
							</ol>
						</nav>
					</div>
				...
				<div class="row">
					<div class="col-xl-9 mx-auto">
						...
						<h6 class="mb-0 text-uppercase">Create Gallery Category </h6>
						<hr/>
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									...
									<form class="row needs-validation" method="post" action="{{ url('admin/gallery/category/create') }}" >
                                    @csrf
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom03" class="form-label">Gallery Name :</label>
