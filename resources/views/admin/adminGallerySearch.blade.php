...
<div class="page-wrapper">
			<div class="page-content">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="p-4 border rounded">
                                        <form class="row g-3 needs-validation" method="post" action="{{ url('/admin/gallery/category') }}" >
                                            @csrf
                                    <div class="col-md-2">
										...
										<div class="col-md-6">
											...
											<select name="catagory_name" class="form-select" id="validationCustom04" required>
                                                ...
                                                @foreach ($galCatData as $galItem)
                                                   <option value="{{ $galItem->name_short }}">{{ $galItem->full_name }}</option>
                                                @endforeach
				...
				<h6 class="mb-0 text-uppercase">Galley images</h6>
				<hr/>
				<div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-4">
                    ...
                    <div class="col">
						<div class="card">
							...
							<img src="{{ url('assets/images/gallery')}}/{{ $item->id.'/'.$item->image_small }}" class="card-img-top" alt="...">
							<div class="card-body">
								<p class="card-title">{{ $item->galley_category }}</p>

								<p class="card-text"></p>	<a href="<?php echo url('/admin/gallery/delete/').'/'. base64_encode($item->id) ;?>" class="btn btn-danger"><i class="bx bx-trash"></i></a>
