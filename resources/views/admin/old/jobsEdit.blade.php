						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									...
									<form class="row needs-validation" method="post" action="{{ url('/admin/jobs/edit') }}/<?php echo base64_encode($newsData[0]->id); ?>" >
                                    @csrf
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom03" class="form-label">Title :</label>
                                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="validationCustom03" value="{{ old('title') ?? $newsData[0]->title }}" required="">
                                        ...
                                        <div class="col-md-6 mb-3">
											...
											<input type="text" name="subTitle" class="form-control @error('subTitle') is-invalid @enderror" id="validationCustom03" value="{{  old('subTitle') ?? $newsData[0]->subTitle  }}" required="">
										...
										<div class="col-md-3 mb-3">
											...
											<input type="text" name="vacancies" class="form-control @error('vacancies') is-invalid @enderror" id="validationCustom03" value="{{  old('vacancies') ?? $newsData[0]->vacancies  }}" required="">
                                        ...
                                        <div class="col-md-3 mb-3">
											...
											<input type="text" name="currency" class="form-control @error('currency') is-invalid @enderror" id="validationCustom03" value="{{  old('currency') ?? $newsData[0]->currency  }}" required="">
                                        ...
                                        <div class="col-md-3 mb-3">
											...
											<input type="text" name="salleryMin" class="form-control @error('salleryMin') is-invalid @enderror" id="validationCustom03" value="{{  old('salleryMin') ?? $newsData[0]->salleryMin  }}" required="">
                                        ...
                                        <div class="col-md-3 mb-3">
											...
											<input type="text" name="salleryMax" class="form-control @error('salleryMax') is-invalid @enderror" id="validationCustom03" value="{{   old('salleryMax') ?? $newsData[0]->salleryMax  }}" required="">
                                            @error('salleryMax')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 mb-3">
											...
											<input type="text" name="jobCategory" class="form-control @error('jobCategory') is-invalid @enderror" id="validationCustom03" value="{{  old('jobCategory') ?? $newsData[0]->jobCategory  }}" required="">
                                            @error('jobCategory')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 mb-3">
											...
											<input type="text" name="education" class="form-control @error('education') is-invalid @enderror" id="validationCustom03" value="{{  old('education') ?? $newsData[0]->education  }}" required="">
                                            @error('education')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 mb-3">
											...
											<input type="text" name="skillRequire" class="form-control @error('skillRequire') is-invalid @enderror" id="validationCustom03" value="{{  old('skillRequire') ?? $newsData[0]->skillRequire  }}" required="">
                                            @error('salleryMax')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 mb-3">
											...
											<input type="text" name="location" class="form-control @error('location') is-invalid @enderror" id="validationCustom03" value="{{  old('location') ?? $newsData[0]->location  }}" required="">
                                            @error('location')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
