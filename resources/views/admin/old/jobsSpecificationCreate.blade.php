			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-9 mx-auto">
						...
						<h6 class="mb-0 text-uppercase">Create Job Specification</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									...
									<form class="row needs-validation" method="post" action="{{ url('/admin/jobs/jobs-specification') }}/ <?php echo $hash_id ;?>" >
                                    @csrf

                                    <div class="col-md-12 mb-3">

                                        <label for="validationCustom03" class="form-label">Specification Point :</label>
